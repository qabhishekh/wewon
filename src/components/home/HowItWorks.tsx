  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-16">
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className="flex items-center justify-start gap-4 sm:gap-6">
              <span className="text-5xl sm:text-6xl font-bold text-[var(--muted-text)]">01</span>
              <div className="bg-[var(--primary)] text-white rounded-xl p-4 sm:p-5 flex items-center space-x-3 shadow-md w-full max-w-md">
                ...
                <span className="text-lg sm:text-xl font-semibold">Enter Your Rank</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-4 sm:gap-6">
              <div className="bg-[var(--primary)] text-white rounded-xl p-4 sm:p-5 flex items-center space-x-3 shadow-md w-full max-w-md">
                ...
                <span className="text-lg sm:text-xl font-semibold">See Your College Options</span>
              </div>
              <span className="text-5xl sm:text-6xl font-bold text-[var(--muted-text)]">02</span>
            </div>
            
            {/* Step 3 */}
            <div className="flex items-center justify-start gap-4 sm:gap-6">
              <span className="text-5xl sm:text-6xl font-bold text-[var(--muted-text)]">03</span>
              <div className="bg-[var(--primary)] text-white rounded-xl p-4 sm:p-5 flex items-center space-x-3 shadow-md w-full max-w-md">
                <UserCheck className="w-6 h-6 flex-shrink-0" />
                <span className="text-lg sm:text-xl font-semibold">Get Expert Guidance</span>
              </div>
            </div>
          </div>
