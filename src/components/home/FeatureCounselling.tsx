...
const counsellingData = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400&h=250&fit=crop&crop=top",
    originalPrice: 4999,
    currentPrice: 2999,
  ...
  },
  {
    ...
    description:
      "Step-by-step NEET counselling process with seat allocation strategies and college selection.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "CAT, XAT, GMAT preparation with personalized study plans and mock tests.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Expert guidance for choosing the right engineering college based on your rank and preferences.",
    imageUrl:
